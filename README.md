...
Chrome 为了优化网络性能，在代理服务器使用上有一些特殊行为。目前已知的问题：对某些被墙网站，COW 需要等待超时来发现被墙，而 Chrome 在等待代理服务器返回响应时间过长时会使用直接连接，这导致有时 Chrome+COW 还是无法访问某些被墙网站。

问题原因我不完全确定，如果你了解 Chrome 的工作机制，欢迎提供解决方案。
